 ...
 */
    ...
    im.mask(selector);
    var selectorEmail = document.getElementById("email");
    Inputmask("email").mask(selectorEmail);
    ...
    function initSliders() {
        if (window.innerWidth < 768) if (document.querySelector(".images__slider")) new swiper_core_Swiper(".images__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
